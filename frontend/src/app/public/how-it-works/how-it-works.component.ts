...
export class HowItWorksComponent implements OnInit {
  ...
  ngOnInit() {
    this.steps = [
      new Step("1. A quick chat", "step1.svg", "Start with a 10-15 minute chat with one of our advisors about " +
      ...
      new Step("2. Fill out your profile", "step2.svg", "Congrats, you’re almost a member of the Planly family!\n" +
        "<br><br>" +
      ...
      new Step("3. Sync your accounts", "step3.svg", "Sync all of your accounts and we’ll provide you with a clear picture of your money in a single place. No need to log in to each account separately anymore, view your balances and transactions directly within Planly.\n" +
        "<br><br>" +
      ...
      new Step("5. Your to-do list", "step5.svg", "We’ve taken your goals and our recommendations and broken them down into actionable steps. Each step has clear instructions on what you need to do in order to implement that part of your plan.\n" +
        "<br><br>" +
